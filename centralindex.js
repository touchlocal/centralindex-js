  ...
  */
   ...
   *  @return - the data from the api
  */
  var postProduct = function (product_id, name, strapline, price, tax_rate, currency, active, billing_period, title, intro_paragraph, bullets, outro_paragraph, thanks_paragraph, callback) {
