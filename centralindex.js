  ...
  */
   ...
   *  @return - the data from the api
  */
  var getAutocompleteCategoryId = function (str, language, callback) {
  ...
  */
   ...
   *  @return - the data from the api
  */
  var putBusinessJson = function (json, country, timezone, master_entity_id, queue_priority, callback) {
  ...
  */
   ...
   *  @return - the data from the api
  */
  var getEntityAdvertisers = function (tag, where, is_national, limit, country, language, benchmark, callback) {
  ...
  */
   ...
   *  @return - the data from the api
  */
  var postEntityAnnouncement = function (entity_id, headline, body, link_label, link, terms_link, expiry_date, media_type, youtube_embed_code, image_url, filedata, type, callback) {
  ...
  */
   ...
   *  @return - the data from the api
  */
  var postEntityClaimRenew = function (entity_id, claimed_user_id, expiry_date, callback) {
   ...
   *  @return - the data from the api
  */
  var postEntityClaimReseller = function (entity_id, callback) {
  ...
  */
   ...
   *  @return - the data from the api
  */
  var postEntityReview = function (entity_id, reviewer_user_id, review_id, title, content, star_rating, domain, callback) {
  ...
  */
   ...
   *  @return - the data from the api
  */
  var getEntityReviewList = function (entity_id, per_page, cursor, callback) {
  ...
  */
   ...
   *  @return - the data from the api
  */
  var getEntitySearchByboundingbox = function (latitude_1, longitude_1, latitude_2, longitude_2, per_page, page, country, language, domain, path, restrict_category_ids, callback) {
   ...
   *  @return - the data from the api
  */
  var getEntitySearchBylocation = function (where, per_page, page, country, language, latitude, longitude, domain, path, restrict_category_ids, benchmark, callback) {
   ...
   *  @return - the data from the api
  */
  var getEntitySearchGroupBynearest = function (group_id, country, per_page, page, language, latitude, longitude, where, domain, path, unitOfDistance, restrict_category_ids, callback) {
   ...
   *  @return - the data from the api
  */
  var getEntitySearchKeywordBynearest = function (keyword, country, per_page, page, language, latitude, longitude, domain, path, restrict_category_ids, include_ads, callback) {
   ...
   *  @return - the data from the api
  */
  var getEntitySearchWhat = function (what, per_page, page, country, language, domain, path, restrict_category_ids, benchmark, callback) {
   ...
   *  @return - the data from the api
  */
  var getEntitySearchWhatByboundingbox = function (what, latitude_1, longitude_1, latitude_2, longitude_2, per_page, page, country, language, domain, path, restrict_category_ids, callback) {
   ...
   *  @return - the data from the api
  */
  var getEntitySearchWhatBylocation = function (what, where, per_page, page, country, language, latitude, longitude, domain, path, restrict_category_ids, benchmark, callback) {
   ...
   *  @return - the data from the api
  */
  var getEntitySearchWhatBynearest = function (what, country, per_page, page, language, latitude, longitude, domain, path, restrict_category_ids, callback) {
   ...
   *  @return - the data from the api
  */
  var getEntitySearchWho = function (who, per_page, page, country, language, domain, path, restrict_category_ids, benchmark, callback) {
   ...
   *  @return - the data from the api
  */
  var getEntitySearchWhoByboundingbox = function (who, latitude_1, longitude_1, latitude_2, longitude_2, per_page, page, country, language, domain, path, restrict_category_ids, callback) {
   ...
   *  @return - the data from the api
  */
  var getEntitySearchWhoBylocation = function (who, where, per_page, page, country, latitude, longitude, language, domain, path, restrict_category_ids, benchmark, callback) {
   ...
   *  @return - the data from the api
  */
  var getEntitySearchWhoBynearest = function (who, country, per_page, page, language, latitude, longitude, domain, path, restrict_category_ids, callback) {
  ...
  */
   ...
   *  @return - the data from the api
  */
  var getLeadsAdded = function (country_id, from_date, to_date, limit, offset, callback) {
   ...
   *  @return - the data from the api
  */
  var getLeadsAdvertisers = function (country_id, from_date, to_date, limit, offset, callback) {
   ...
   *  @return - the data from the api
  */
  var getLeadsClaimed = function (country_id, from_date, to_date, limit, offset, callback) {
  ...
  */
   ...
   *  @return - the data from the api
  */
  var postPaintBy_ingest_job_id = function (ingest_job_id, callback) {
   ...
   *  @return - the data from the api
  */
  var postPlugin = function (id, slug, owner, scope, status, callback) {
  ...
  */
   ...
   *  @return - the data from the api
  */
  var postPluginActivate = function (entity_id, plugin, expiry_date, callback) {
  ...
  */
   ...
   *  @return - the data from the api
  */
  var postProduct = function (product_id, name, strapline, paygateid, price, tax_rate, currency, active, billing_period, title, intro_paragraph, bullets, outro_paragraph, thanks_paragraph, callback) {
  ...
  */
   ...
   *  @return - the data from the api
  */
  var postScoot_priority = function (entity_id, reseller, callback) {
   ...
   *  @return - the data from the api
  */
  var putShortenurl = function (url, callback) {
  ...
  */
   ...
   *  @return - the data from the api
  */
  var getTokenClaim = function (entity_id, language, portal_name, flatpack_id, admin_host, callback) {
  ...
  */
   ...
   *  @return - the data from the api
  */
  var getTokenLoginSet_password = function (email, flatpack_id, entity_id, action, callback) {
