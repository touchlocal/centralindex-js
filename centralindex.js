  ...
  */
   ...
   *  @return - the data from the api
  */
  var getAutocompleteLocz = function (str, country, language, callback) {
    ...
    doCurl("/autocomplete/locz",params,function(error,body){
      callback(error,body);
    })
  }
   ...
   *  @return - the data from the api
  */
  var getAutocompleteLoczBy_resolution = function (str, country, resolution, callback) {
    ...
    doCurl("/autocomplete/locz/by_resolution",params,function(error,body){
      callback(error,body);
    })
  }
   ...
   *  @return - the data from the api
  */
  var putBusiness = function (name, building_number, address1, address2, address3, district, town, county, province, postcode, country, latitude, longitude, timezone, telephone_number, additional_telephone_number, email, website, category_id, category_type, do_not_display, referrer_url, referrer_name, callback) {
  ...
  */
   ...
   *  @return - the data from the api
  */
  var postCountry = function (country_id, name, synonyms, continentName, continent, geonameId, dbpediaURL, freebaseURL, population, currencyCode, languages, areaInSqKm, capital, east, west, north, south, claimPrice, claimMethods, nokia_country_code, twilio_sms, twilio_phone, twilio_voice, currency_symbol, currency_symbol_html, callback) {
  ...
  */
   ...
   *  @return - the data from the api
  */
  var postEntityClaim = function (entity_id, claimed_user_id, claimed_date, claim_method, phone_number, referrer_url, referrer_name, callback) {
  ...
  */
   ...
   *  @return - the data from the api
  */
  var postLocationSynonymBulk = function (filedata, callback) {

    params = {};
    params.filedata = filedata;
    
    doCurl("/location/synonym/bulk",params,function(error,body){
      callback(error,body);
    })
  }
   ...
   *  @return - the data from the api
  */
  var getLocz = function (location_id, callback) {

    params = {};
    params.location_id = location_id;
    
    doCurl("/locz",params,function(error,body){
      callback(error,body);
    })
  }
   ...
   *  @return - the data from the api
  */
  var postLocz = function (location_id, type, country, language, name, formal_name, resolution, population, description, timezone, latitude, longitude, parent_town, parent_county, parent_province, parent_region, parent_neighbourhood, parent_district, postalcode, searchable_id, searchable_ids, callback) {
   ...
   *  @return - the data from the api
  */
  var getLoczMultiple = function (location_ids, callback) {

    params = {};
    params.location_ids = location_ids;
    
    doCurl("/locz/multiple",params,function(error,body){
      callback(error,body);
    })
  }
  ...
  */
   ...
   *  @return - the data from the api
  */
  var getLookupLocz = function (string, language, country, latitude, longitude, callback) {
    ...
    doCurl("/lookup/locz",params,function(error,body){
      callback(error,body);
    })
  }
  ...
  */
   ...
   *  @return - the data from the api
  */
  var postSignal = function (entity_id, country, gen_id, signal_type, data_type, callback) {
  ...
  */
   ...
   *  @return - the data from the api
  */
  var postUser = function (email, first_name, last_name, active, trust, creation_date, user_type, social_network, social_network_id, reseller_admin_masheryid, group_id, admin_upgrader, callback) {
  ...
  */
  ...
  module.exports = {
    ...
    getAutocompleteLocz: getAutocompleteLocz,
    getAutocompleteLoczBy_resolution: getAutocompleteLoczBy_resolution,
    ...
    postLocationSynonymBulk: postLocationSynonymBulk,
    getLocz: getLocz,
    postLocz: postLocz,
    getLoczMultiple: getLoczMultiple,
    getLogo: getLogo,
    putLogo: putLogo,
